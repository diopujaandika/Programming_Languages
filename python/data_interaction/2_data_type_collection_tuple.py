...
#Slicing => Pengambilan data berdasarkan indeks dri rentang tertentu => sequence[start:stop:step]
sistemOperasi = ["MacOS", "Linux", "Windows", "Android", "Ubuntu", "Debian"]
print(sistemOperasi[0:5:2])