...
//1. Konversi Eksplisit
    //a. Mengubah ke String dengan fungsi String(NamaVariable); dan namaVariable.toString();
        const number = 123;
        const boolean = true;
        //Cara Convert
    ...
    //b. Mengubah ke Number dengan Number(namaVariable);
        ...
        const px = '61.1px';
        //Convert
        const intFromCM = parseInt(cm);  //parseInt(namaVariable); untuk menjadi bilangan bulat
        const intFromPX = parseFloat(px); //parseFloat(namaVariable); untuk menjadi bilangan pecahan
        //Output
        console.log(intFromCM, intFromPX);

    //c. Mengubah ke Boolean dengan fungsi Boolean(namaVariable);
